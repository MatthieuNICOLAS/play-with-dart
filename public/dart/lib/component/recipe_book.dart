  ...
  List<Recipe> _loadData() {
    return [
      new Recipe('My Appetizer','Appetizers',
          ...
          "Some Directions", 1, "/images/fonzie1.jpg"),
      new Recipe('My Salad','Salads',
          ["Ingredient 1", "Ingredient 2"],
          "Some Directions", 3, "/images/fonzie2.jpg"),
      new Recipe('My Soup','Soups',
          ["Ingredient 1", "Ingredient 2"],
          "Some Directions", 4, "/images/fonzie1.jpg"),
      new Recipe('My Main Dish','Main Dishes',
          ["Ingredient 1", "Ingredient 2"],
          "Some Directions", 2, "/images/fonzie2.jpg"),
      new Recipe('My Side Dish','Side Dishes',
          ["Ingredient 1", "Ingredient 2"],
          "Some Directions", 3, "/images/fonzie1.jpg"),
      new Recipe('My Awesome Dessert','Desserts',
          ["Ingredient 1", "Ingredient 2"],
          "Some Directions", 5, "/images/fonzie2.jpg"),
